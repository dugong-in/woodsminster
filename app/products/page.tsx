              ...
              >
                ...
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <h3 className="text-lg md:text-xl font-semibold text-maroon-800 dark:text-maroon-100">
                      {product.name}
                    </h3>
                  </div>
                  <p className="text-lg md:text-xl font-bold text-maroon-800 dark:text-maroon-200">
