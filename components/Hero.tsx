    ...
    <section className="min-h-screen flex items-center justify-center bg-gradient-to-br from-maroon-100 to-white dark:from-maroon-950 dark:to-maroon-900 pt-20">
      <div className="container mx-auto px-6 py-20">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <motion.h1
              className="text-5xl md:text-7xl font-bold text-maroon-800 dark:text-maroon-100 mb-6 leading-tight"
            ...
            >
              Discover economical wooden furniture that transforms your space
              with timeless elegance and modern simplicity.
            </motion.p>
            <motion.div
