...
export default function Contact() {
  return (
    <section
      id="contact"
      className="py-20 bg-maroon-900 dark:bg-maroon-950 text-white"
    >
      <div className="container mx-auto px-6">
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-maroon-200 dark:text-maroon-300">
          ...
          >
            ...
            <motion.button
              type="submit"
              className="md:col-span-2 bg-white text-maroon-800 px-8 py-4 rounded-full text-lg font-semibold"
